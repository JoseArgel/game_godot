...
var needs_reboot:bool = false: set = set_needs_reboot



func _ready():
	process_mode = Node.PROCESS_MODE_ALWAYS
	check_button_show_hud.button_pressed = ShowcaseSettings.get_setting_val("show_hud")
	check_button_sound.button_pressed = ShowcaseSettings.get_setting_val("sound")
	slider_sound_volume.value = ShowcaseSettings.get_setting_val("sound_volume")
	check_button_fullscreen.button_pressed = ShowcaseSettings.get_setting_val("fullscreen")
	slider_rendering_quality.value = ShowcaseSettings.get_setting_val("rendering_quality")
	check_button_dof_blur.button_pressed = ShowcaseSettings.get_setting_val("dof_blur")
	slider_dof_blur_quality.value = ShowcaseSettings.get_setting_val("dof_blur_quality")
	check_button_vsync.button_pressed = ShowcaseSettings.get_setting_val("vsync")
